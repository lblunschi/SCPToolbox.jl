...
struct AUVParameters
    ...
    v_min::T_Real    # [m/s] Minimum velocity
    v_min_u::T_Real  # [m/s] Minimum forward velocity (no reverse)
end
...
function AUVProblem()::AUVProblem
    ...
    auv = AUVParameters(id_r, id_v, id_u, id_t,
                               u_max, u_min, v_max, v_min, v_min_u)
    ...
    rf[4] = 0.0#-pi/2 # Terminal yaw of 90° 
    ...
    tf_max = 100.0 # Maximum flight time
    γ = 0.5 # Minimum-time vs. minimum-energy tradeoff (1: min time, 0: min energy)
